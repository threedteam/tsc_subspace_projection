...
"""
    ...
    @author: Jindong Wang
    But I have modified the code in some places
"""
import numpy as np
import scipy.io
import scipy.linalg
    ...
    def fit_predict(self, Xs, Ys, Xt, Yt):
        ...
        for t in range(self.T):
            ...
            if Y_tar_pseudo is not None and len(Y_tar_pseudo) == nt:
                # Modifications are needed to change what JDA cannot iterate
                for c in np.unique(Y_tar_pseudo):
            ...
            if isinstance(Xs_new[0][0],complex) == False:
